...
Object.assign(KHBAdmin.config, {
  ...
  SUPABASE_URL,
  SUPABASE_ANON_KEY,
  AUDIO_BASE_URL: ADMIN_CONFIG.AUDIO_BASE_URL,
  TOKEN_PREFIX: ADMIN_CONFIG.TOKEN_PREFIX || 'khb-',
  TOKEN_LENGTH: Number.isInteger(ADMIN_CONFIG.TOKEN_LENGTH) ? ADMIN_CONFIG.TOKEN_LENGTH : 32,
});
